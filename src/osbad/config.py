...
HP_DATA_SOURCE: DataSource = "severson"
...
def load_model_hp_configs(
    ...
    if schema_base_dir is None:
        ...
        schema_base_dir = repo_root / "machine_learning" / "hp_config_schema"

    # Build full schema directory path for this data source
    schema_dir = schema_base_dir / f"{data_source}_hp_config"

    configs: dict[str, Any] = {}
    for model in models:
        json_path = schema_dir / f"{model}_hp_config.json"
...
iforest_hp_config_severson  = severson_hp_configs["iforest"]
knn_hp_config_severson = severson_hp_configs["knn"]
gmm_hp_config_severson = severson_hp_configs["gmm"]
lof_hp_config_severson = severson_hp_configs["lof"]
pca_hp_config_severson = severson_hp_configs["pca"]
autoencoder_hp_config_severson = severson_hp_configs["autoencoder"]
...
iforest_hp_config_tohoku = tohoku_hp_configs["iforest"]
knn_hp_config_tohoku = tohoku_hp_configs["knn"]
gmm_hp_config_tohoku = tohoku_hp_configs["gmm"]
lof_hp_config_tohoku = tohoku_hp_configs["lof"]
pca_hp_config_tohoku = tohoku_hp_configs["pca"]
autoencoder_hp_config_tohoku = tohoku_hp_configs["autoencoder"]


# # Get the path of the current script
# # Don't use Path.cwd() because it will change depending on where the
# # module is being imported in the notebook
# current_config_filepath = Path(__file__)
...
#         "hp_config_schema",
#         "iforest_hp_config.json"))
# iforest_hp_config = load_json_hp_config(iforest_hp_config_filepath)
...
#         "hp_config_schema",
#         "knn_hp_config.json"))
# knn_hp_config = load_json_hp_config(knn_hp_config_filepath)
...
#         "hp_config_schema",
#         "gmm_hp_config.json"))
# gmm_hp_config = load_json_hp_config(gmm_hp_config_filepath)
...
#         "hp_config_schema",
#         "lof_hp_config.json"))
# lof_hp_config = load_json_hp_config(lof_hp_config_filepath)
...
#         "hp_config_schema",
#         "pca_hp_config.json"))
# pca_hp_config = load_json_hp_config(pca_hp_config_filepath)
...
# autoencoder_hp_config = load_json_hp_config(autoencoder_hp_config_filepath)
