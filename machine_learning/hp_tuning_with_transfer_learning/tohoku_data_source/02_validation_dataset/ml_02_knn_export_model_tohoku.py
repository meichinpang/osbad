...
if __name__ == "__main__":
    ...
    output_fig_filename = (
        "export_model_knn_pred_cycles_with_outliers_"
        + selected_cell_label
        + ".png")
    ...
    output_fig_filename = (
        "export_model_knn_pred_cap_fade_with_outliers_"
        + selected_cell_label
        + ".png")
    ...
    export_model_filepath = EXPORT_MODEL_DIR.joinpath(
        f"knn_train_{selected_cell_label}.joblib")
