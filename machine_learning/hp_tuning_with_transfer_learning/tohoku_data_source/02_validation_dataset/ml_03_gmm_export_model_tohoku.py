...
if __name__ == "__main__":
    ...
    output_fig_filename = (
        f"export_model_gmm_grid_offset_size_{GRID_OFFSET_SIZE}_"
        + selected_cell_label
        + ".png")
    ...
    output_fig_filename = (
        "export_model_gmm_pred_cycles_with_outliers_"
        + selected_cell_label
        + ".png")
    ...
    output_fig_filename = (
        "export_model_gmm_pred_cap_fade_with_outliers_"
        + selected_cell_label
        + ".png")
    ...
    export_model_filepath = EXPORT_MODEL_DIR.joinpath(
        f"gmm_train_{selected_cell_label}.joblib")
