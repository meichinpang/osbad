...
if __name__ == "__main__":
    ...
    output_fig_filename = (
        f"export_model_autoencoder_grid_offset_size_{GRID_OFFSET_SIZE}_"
        + selected_cell_label
        + ".png")
    ...
    output_fig_filename = (
        "export_model_autoencoder_pred_cycles_with_outliers_"
        + selected_cell_label
        + ".png")
    ...
    output_fig_filename = (
        "export_model_autoencoder_pred_cap_fade_with_outliers_"
        + selected_cell_label
        + ".png")
