...
if __name__ == "__main__":
    ...
    for idx, selected_cell_label in enumerate(unique_cell_index_test):
        ...
        # Get the average value of each hyperparameter from the CSV file
        avg_threshold = (
        ...
        output_fig_filename = (
            f"lof_grid_offset_size_{GRID_OFFSET_SIZE}_"
            + selected_cell_label
            + ".png")
        ...
        output_fig_filename = (
            "lof_pred_cycles_with_outliers_"
            + selected_cell_label
            + ".png")
        ...
        output_fig_filename = (
            "lof_pred_cap_fade_with_outliers_"
            + selected_cell_label
            + ".png")
