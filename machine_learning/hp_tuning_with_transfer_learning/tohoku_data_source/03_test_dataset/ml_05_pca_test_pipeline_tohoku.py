...
hyperparam_filepath = current_path.parent.parent.joinpath(
    ...
    "hp_05_pca_hyperparam_tohoku.csv")
...
if __name__ == "__main__":
    ...
    for idx, selected_cell_label in enumerate(unique_cell_index_test):
        ...
        # --------------------------------------------------------------------
        # Test Principal Component Analysis (PCA) model
        ...
        output_fig_filename = (
            f"pca_grid_offset_size_{GRID_OFFSET_SIZE}_"
            + selected_cell_label
            + ".png")
        ...
        axplot.set_title(
            f"Cell-{cell_num}: Predicted Anomalies with PCA",
            fontsize=16)

        output_fig_filename = (
            "pca_pred_cycles_with_outliers_"
            + selected_cell_label
            + ".png")
        ...
        output_fig_filename = (
            "pca_pred_cap_fade_with_outliers_"
            + selected_cell_label
            + ".png")
